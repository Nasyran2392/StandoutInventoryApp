...
class PickUpItemsPage extends StatefulWidget {
  final String stockInTaskId;

  PickUpItemsPage({required this.stockInTaskId});

  @override
  _PickUpItemsPageState createState() => _PickUpItemsPageState();
}

class _PickUpItemsPageState extends State<PickUpItemsPage> {
